...
const GOOGLE_FORM_URL = 'https://docs.google.com/forms/d/e/1FAIpQLScnTzvmSyqo9rpOlrk490XoZTjvfeWHfk9XyuD1EroUhFGNpA/formResponse';
...
export const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Отправка в Google Form через типизированный ApiClient
            await api.post(GOOGLE_FORM_URL, formData, {
                mode: 'no-cors',
            });
